<script lang="ts">
	...
	import ImageComponent from '../../routes/ImageComponent.svelte';
...
<Resizable.Pane defaultSize={25}>
    <Card.Root class="h-full w-full">
        ...
        <Card.Content>
            ...
            <br>
            <br>
            NeuralLab is an interactive online platform designed to teach neural network concepts
            in artificial intelligence. Through its interactive, accessible, and easy to learn neural
            network, it offers lessons that enable learners to explore AI concepts at their own pace.
            The user-friendly interface also allows visitors to apply their ideas using custom datasets
            for real-time training, promoting both exploration and curiosity in AI.
        </Card.Content>
